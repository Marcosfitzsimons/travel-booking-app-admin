...
import { SpecialTrip, Trip } from "@/types/types";
...
const SpecialTripsHistoryDatatable = <TData, TValue>({
  columns,
  ...
  const baseUrl = "/special-trips/history";
    ...
    toast({
      ...
      description: (
        <div className="flex gap-1">
          ...
          Eliminando viaje particular...
        </div>
      ),
    });
    try {
      await axiosPrivate.delete(`/special-trips/${id}`);
      ...
      toast({
        description: (
          <div className="flex gap-1">
            ...
            particular ha sido eliminado con éxito
          </div>
        ),
      });
    } catch (err: any) {
      ...
      toast({
        ...
        title: (
          <div className="flex gap-1">
            ...
            Error al eliminar viaje particular
          </div>
        ) as any,
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                ...
                >
                  {loading
                    ? "Cargando historial de viajes particulares..."
                    : "Historial de viajes particulares no disponible."}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
