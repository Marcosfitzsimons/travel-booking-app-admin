  ...
  return (
    <div className="flex flex-1 items-center">
      <GorgeousBorder className="w-full">
        ...
        <TimePicker
          disableClock
          className="w-full pl-8 pr-2.5 py-1.5 relative text-sm bg-input-bg rounded-lg border border-slate-400/60 shadow-input placeholder:text-foreground dark:border-slate-800 dark:placeholder:text-zinc-300 dark:text-zinc-300 dark:placeholder:hover:text-white dark:hover:text-white dark:shadow-none !outline-none"
          onChange={onChange}
